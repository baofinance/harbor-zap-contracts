...
echo "=== Deploying MinterETHZap_v1 (UUPS) ==="
echo ""

IMPLEMENTATION_PATH="src/zap/upgradeable/MinterETHZap_v1.sol:MinterETHZap_v1"
...
if ! verify_contract "$impl_address" "$IMPLEMENTATION_PATH" "$impl_ctor_args" "MinterETHZap_v1 implementation"; then
  exit 1
fi
