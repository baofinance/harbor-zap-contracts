...
echo "=== Deploying GenesisUSDCZap_v1 (UUPS) ==="
echo ""

IMPLEMENTATION_PATH="src/zap/upgradeable/GenesisUSDCZap_v1.sol:GenesisUSDCZap_v1"
...
if ! verify_contract "$impl_address" "$IMPLEMENTATION_PATH" "$impl_ctor_args" "GenesisUSDCZap_v1 implementation"; then
  exit 1
fi
